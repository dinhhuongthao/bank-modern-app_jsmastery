		...
		>
			...
			>
				...
				<p className={`${styles.paragraph} max-w-[470px] mt-5`}>
					...
					quaerat, sed numquam velit maxime optio ipsam dolorem repellat dolor
					officia, error tempore. Deserunt reprehenderit nobis, natus totam
					aliquam possimus fuga.
				</p>
			</div>
